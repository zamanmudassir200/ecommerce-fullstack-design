...
// //           </Link>
// //         </div>
// //         <div className="xl:w-[665px] md:w-[400px] overflow-hidden flex items-center justify-between  rounded-lg h-[40px] border-2 border-[#127FFF]">
// //           <input
...
//         {/* Navigation Icons */}
//         <div className="w-full md:w-auto flex items-center justify-between sm:justify-center gap-2 sm:gap-4 md:gap-6">
//           {navLinks.map((link, index) => (
//             <div key={index} className="flex flex-col">
//               <Link
...
const Header = () => {
  ...
  // Desktop navigation links (only show cart and profile on mobile)
