...
const JoinNowModal = ({ setIsJoinNowModalOpen }) => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 backdrop-brightness-50 flex items-center justify-center min-h-screen   bottom-0 z-50 inset-0 ">
      <div className=" rounded-lg   px-2 py-5  bg-white ">
        <div className=" flex items-center justify-between top-3 right-3">
          ...
          <MdClose onClick={() => setIsJoinNowModalOpen(false)} size={24} />
        </div>
